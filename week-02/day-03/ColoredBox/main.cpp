...
void draw()
{
    ...
    SDL_RenderDrawLine(gRenderer, 200, 100, 400, 100);
    SDL_SetRenderDrawColor(gRenderer, 0 /*R*/, 255 /*G*/, 0 /*B*/, 0xFF /*A*/);
    SDL_RenderDrawLine(gRenderer, 400, 100, 400, 200);
    SDL_SetRenderDrawColor(gRenderer, 255 /*R*/, 255 /*G*/, 0 /*B*/, 0xFF /*A*/);
    SDL_RenderDrawLine(gRenderer, 400, 200, 200, 200);
    SDL_SetRenderDrawColor(gRenderer, 0 /*R*/, 255 /*G*/, 255 /*B*/, 0xFF /*A*/);
    SDL_RenderDrawLine(gRenderer, 200, 200, 200, 100);
